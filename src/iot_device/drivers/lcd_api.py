...
class LcdApi:
    ...
    def putstr_line1(self, string):
        self.move_to(0,0)
        string_to_write = string if(len(string) < self.num_columns) else string[0:self.num_columns]
        self.putstr(string_to_write)


    def putstr_line2(self, string):
        self.move_to(0,1)
        string_to_write = string if(len(string) < self.num_columns) else string[0:self.num_columns]
        self.putstr(string_to_write)
